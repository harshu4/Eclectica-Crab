...
RetryOperation.prototype.reset = function () {
    ...
    return t
}, exports = retry$2, RetryOperation2 = retry_operation, exports.operation = function (e) {
    var t = exports.timeouts(e);
    return new RetryOperation2(t, {
        forever: e && (e.forever || e.retries === 1 / 0),
        unref: e && e.unref,
        maxRetryTime: e && e.maxRetryTime
    })
}, exports.timeouts = function (e) {
...
}, exports.createTimeout = function (e, t) {
    ...
    for (var o = 0; o < r.length; o++) {
        var i = r[o],
            s = e[i];
        e[i] = function (r) {
            var n = exports.operation(t),
                o = Array.prototype.slice.call(arguments, 1),
                i = o.pop();
            o.push((function (e) {
                n.retry(e) || (e && (arguments[0] = n.mainError()), i.apply(this, arguments))
            })), n.attempt((function () {
                r.apply(e, o)
            }))
        }.bind(e, s), e[i].options = t
    }
};
var retry$1 = retry$2;
const retry = retry$1,
    ...
    pRetry = (e, t) => new Promise(((r, n) => {
        ...
        o.attempt((async i => {
            try {
                ...
                if (!(s instanceof Error)) return void n(new TypeError(`Non-error was thrown: "${s}". You should only throw errors.`));
                if (s instanceof AbortError) o.stop(), n(s.originalError);
                else if (s instanceof TypeError && !isNetworkError(s.message)) o.stop(), n(s);
                else {
                    decorateErrorWithCounts(s, i, t);
                    try {
                        await t.onFailedAttempt(s)
                    } catch (a) {
                        return void n(a)
                    }
                    o.retry(s) || n(o.mainError())
                }
            }
        }))
    }));
    ...
    function f(e) {
        ...
        if (" " !== e[t]) {
            ...
            for (var i = (e.length - t) * u + 1 >>> 0, s = new Uint8Array(i); e[t];) {
                ...
                if (255 === l) return;
                for (var f = 0, h = i - 1;
                    (0 !== l || f < o) && -1 !== h; h--, f++) l += a * s[h] >>> 0, s[h] = l % 256 >>> 0, l = l / 256 >>> 0;
    ...
    return {
        encode: function (t) {
            ...
            for (var s = (i - o) * l + 1 >>> 0, u = new Uint8Array(s); o !== i;) {
                for (var f = t[o], h = 0, d = s - 1;
                    (0 !== f || h < n) && -1 !== d; d--, h++) f += 256 * u[d] >>> 0, u[d] = f % a >>> 0, f = f / a >>> 0;
...
class Decoder {
    ...
    decode(e) {
        if ("string" != typeof e) throw Error("Can only multibase decode strings");
        switch (e[0]) {
            case this.prefix:
...
const from$1 = ({
    ...
    decode$6 = (e, t, r, n) => {
        ...
        for (let l = 0; l < i; ++l) {
            ...
            c = c << r | t, a += r, a >= 8 && (a -= 8, s[u++] = 255 & c >> a)
        }
    ...
    encode$6 = (e, t, r) => {
        ...
        for (let c = 0; c < e.length; ++c)
            for (a = a << 8 | e[c], s += 8; s > r;) s -= r, i += t[o & a >> s];
        if (s && (i += t[o & a << r - s]), n)
            for (; i.length * r & 7;) i += "=";
        return i
    },
...
class CID$1 {
    ...
    toString(e) {
        ...
        switch (r) {
            ...
            default:
                return toStringV1(t, n, e || base32$1.encoder)
        }
    }
    toJSON() {
        return {
    ...
    static parse(e, t) {
        const [r, n] = parseCIDtoBytes(e, t), o = CID$1.decode(n);
...
const toString = useBuffer ? (e, t, r) => r - t > 64 ? globalThis.Buffer.from(e.subarray(t, r)).toString("utf8") : utf8Slice(e, t, r) : (e, t, r) => r - t > 64 ? textDecoder$1.decode(e.subarray(t, r)) : utf8Slice(e, t, r),
    ...
    concat$2 = useBuffer ? (e, t) => (e = e.map((e => e instanceof Uint8Array ? e : globalThis.Buffer.from(e))), asU8A(globalThis.Buffer.concat(e, t))) : (e, t) => {
        ...
        let n = 0;
        for (let o of e) n + o.length > r.length && (o = o.subarray(0, r.length - n)), r.set(o, n), n += o.length;
        return r
    },
...
const simpleTokens = {
    ...
    typeEncoders = {
        ...
        Array(e, t, r, n) {
            ...
            const o = [];
            let i = 0;
            for (const s of e) o[i++] = objectToTokens(s, r, n);
        ...
        Object(e, t, r, n) {
            ...
            const a = [];
            let c = 0;
            for (const u of i) a[c++] = [objectToTokens(u, r, n), objectToTokens(o ? e.get(u) : e[u], r, n)];
...
async function decodeReaderComplete(e) {
    const t = createDecoder(e),
        ...
        o = [];
    for await (const i of t.blocks()) o.push(i);
...
! function (e, t) {
    ! function (r, n) {
        ...
        function c(e) {
            return e = s(e ^= e >>> 16, 2246822507), e = s(e ^= e >>> 13, 3266489909), e ^= e >>> 16
        }
        ...
        function p(e) {
            return e = d(e, [0, e[0] >>> 1]), e = d(e = l(e, [4283543511, 3981806797]), [0, e[0] >>> 1]), e = d(e = l(e, [3301882366, 444984403]), [0, e[0] >>> 1])
        }
        o.x86.hash32 = function (e, t) {
            if (o.inputValidation && !i(e)) return n;
            t = t || 0;
            for (var r = e.length % 4, u = e.length - r, l = t, f = 0, h = 3432918353, d = 461845907, p = 0; p < u; p += 4) f = s(f = e[p] | e[p + 1] << 8 | e[p + 2] << 16 | e[p + 3] << 24, h), f = s(f = a(f, 15), d), l = s(l = a(l ^= f, 13), 5) + 3864292196;
            switch (f = 0, r) {
                case 3:
                    f ^= e[p + 2] << 16;
                case 2:
                    f ^= e[p + 1] << 8;
                case 1:
                    f = s(f ^= e[p], h), l ^= f = s(f = a(f, 15), d)
            }
            return (l = c(l ^= e.length)) >>> 0
        }, o.x86.hash128 = function (e, t) {
            if (o.inputValidation && !i(e)) return n;
            t = t || 0;
            for (var r = e.length % 16, u = e.length - r, l = t, f = t, h = t, d = t, p = 0, y = 0, m = 0, g = 0, b = 597399067, w = 2869860233, _ = 951274213, v = 2716044179, $ = 0; $ < u; $ += 16) p = e[$] | e[$ + 1] << 8 | e[$ + 2] << 16 | e[$ + 3] << 24, y = e[$ + 4] | e[$ + 5] << 8 | e[$ + 6] << 16 | e[$ + 7] << 24, m = e[$ + 8] | e[$ + 9] << 8 | e[$ + 10] << 16 | e[$ + 11] << 24, g = e[$ + 12] | e[$ + 13] << 8 | e[$ + 14] << 16 | e[$ + 15] << 24, p = a(p = s(p, b), 15), l = a(l ^= p = s(p, w), 19), l = s(l += f, 5) + 1444728091, y = a(y = s(y, w), 16), f = a(f ^= y = s(y, _), 17), f = s(f += h, 5) + 197830471, m = a(m = s(m, _), 17), h = a(h ^= m = s(m, v), 15), h = s(h += d, 5) + 2530024501, g = a(g = s(g, v), 18), d = a(d ^= g = s(g, b), 13), d = s(d += l, 5) + 850148119;
            switch (p = 0, y = 0, m = 0, g = 0, r) {
                case 15:
                    g ^= e[$ + 14] << 16;
                case 14:
                    g ^= e[$ + 13] << 8;
                case 13:
                    g = s(g ^= e[$ + 12], v), d ^= g = s(g = a(g, 18), b);
                case 12:
                    m ^= e[$ + 11] << 24;
                case 11:
                    m ^= e[$ + 10] << 16;
                ...
                case 2:
                    p ^= e[$ + 1] << 8;
                case 1:
                    p = s(p ^= e[$], b), l ^= p = s(p = a(p, 15), w)
            }
            return l ^= e.length, l += f ^= e.length, l += h ^= e.length, f += l += d ^= e.length, h += l, d += l, l = c(l), l += f = c(f), l += h = c(h), f += l += d = c(d), h += l, d += l, ("00000000" + (l >>> 0).toString(16)).slice(-8) + ("00000000" + (f >>> 0).toString(16)).slice(-8) + ("00000000" + (h >>> 0).toString(16)).slice(-8) + ("00000000" + (d >>> 0).toString(16)).slice(-8)
        }, o.x64.hash128 = function (e, t) {
            if (o.inputValidation && !i(e)) return n;
            t = t || 0;
            for (var r = e.length % 16, s = e.length - r, a = [0, t], c = [0, t], y = [0, 0], m = [0, 0], g = [2277735313, 289559509], b = [1291169091, 658871167], w = 0; w < s; w += 16) y = [e[w + 4] | e[w + 5] << 8 | e[w + 6] << 16 | e[w + 7] << 24, e[w] | e[w + 1] << 8 | e[w + 2] << 16 | e[w + 3] << 24], m = [e[w + 12] | e[w + 13] << 8 | e[w + 14] << 16 | e[w + 15] << 24, e[w + 8] | e[w + 9] << 8 | e[w + 10] << 16 | e[w + 11] << 24], y = f(y = l(y, g), 31), a = u(a = f(a = d(a, y = l(y, b)), 27), c), a = u(l(a, [0, 5]), [0, 1390208809]), m = f(m = l(m, b), 33), c = u(c = f(c = d(c, m = l(m, g)), 31), a), c = u(l(c, [0, 5]), [0, 944331445]);
            switch (y = [0, 0], m = [0, 0], r) {
                case 15:
                    m = d(m, h([0, e[w + 14]], 48));
                case 14:
                    m = d(m, h([0, e[w + 13]], 40));
                ...
                case 10:
                    m = d(m, h([0, e[w + 9]], 8));
                case 9:
                    m = l(m = d(m, [0, e[w + 8]]), b), c = d(c, m = l(m = f(m, 33), g));
                case 8:
                    y = d(y, h([0, e[w + 7]], 56));
                case 7:
                    y = d(y, h([0, e[w + 6]], 48));
                ...
                case 2:
                    y = d(y, h([0, e[w + 1]], 8));
                case 1:
                    y = l(y = d(y, [0, e[w]]), g), a = d(a, y = l(y = f(y, 31), b))
            }
            return a = u(a = d(a, [0, e.length]), c = d(c, [0, e.length])), c = u(c, a), a = u(a = p(a), c = p(c)), c = u(c, a), ("00000000" + (a[0] >>> 0).toString(16)).slice(-8) + ("00000000" + (a[1] >>> 0).toString(16)).slice(-8) + ("00000000" + (c[0] >>> 0).toString(16)).slice(-8) + ("00000000" + (c[1] >>> 0).toString(16)).slice(-8)
        }, e.exports && (t = e.exports = o), t.murmurHash3 = o
    }()
...
var defaultOptions$1 = (e = {}) => mergeOptions(defaultOptions, e);
...
var utf8$2 = {},
    utf82;
utf82 = utf8$2, utf82.length = function (e) {
...
function Service(e, t, r) {
    ...
    if (s.rpcImpl) try {
        ...
        return s.emit("error", a, t), void setTimeout((function () {
            i(a)
        }), 0)
...
function encodeNode(e) {
    ...
    if (e.Data && (n -= e.Data.length, r.set(e.Data, n), n = encodeVarint(r, n, e.Data.length) - 1, r[n] = 10), e.Links)
        for (let o = e.Links.length - 1; o >= 0; o--) {
            const t = encodeLink(e.Links[o], r.subarray(0, n));
            n -= t, n = encodeVarint(r, n, t) - 1, r[n] = 18
        }
    return r
}
...
async function* bufferImporter(e, t, r) {
    for await (let n of e.content) yield async () => {
        ...
        return r.rawLeaves ? (i.codec = raw$2, i.cidVersion = 1) : (o = new UnixFS({
            type: r.leafType,
            data: n,
            mtime: e.mtime,
            mode: e.mode
...
const reduce = (e, t, r) => async function (n) {
    if (1 === n.length && n[0].single && r.reduceSingleLeafToSelf) {
        ...
        if (o.cid.code === code$1 && (void 0 !== e.mtime || void 0 !== e.mode)) {
            ...
            })), o.cid = await persist(n, t, __spreadProps(__spreadValues({}, r), {
                codec: pb,
                hasher: r.hasher,
                cidVersion: r.cidVersion
            })), o.size = n.length
...
! function (e) {
    ...
    function a(e, t, r) {
        ...
        const o = function (e) {
            ...
            if (void 0 !== e.length) return "number" != typeof e.length || Y(e.length) ? i(0) : l(e);
    ...
    e.kMaxLength = o, s.TYPED_ARRAY_SUPPORT = function () {
        ...
        for (r = 0; r < e.length; ++r) {
            let t = e[r];
            if (G(t, Uint8Array)) o + t.length > n.length ? (s.isBuffer(t) || (t = s.from(t)), t.copy(n, o)) : Uint8Array.prototype.set.call(n, t, o);
            else {
    ...
    function F(e, t, r, n, o, i) {
        if (e > r || e < t) {
            ...
            let o;
            throw o = i > 3 ? 0 === t || t === BigInt(0) ? `>= 0${n} and < 2${n} ** ${8*(i+1)}${n}` : `>= -(2${n} ** ${8*(i+1)-1}${n}) and < 2 ** ${8*(i+1)-1}${n}` : `>= ${t}${n} and <= ${r}${n}`, new P.ERR_OUT_OF_RANGE("value", o, e)
        }! function (e, t, r) {
    ...
    }), RangeError), L("ERR_INVALID_ARG_TYPE", (function (e, t) {
        return `The "${e}" argument must be of type number. Received type ${typeof t}`
    }), TypeError), L("ERR_OUT_OF_RANGE", (function (e, t, r) {
...
BufferList._init = function (e) {
        ...
        for (let l = i[0]; l < this._bufs.length; l++) {
            const t = this._bufs[l].length - u;
            if (!(a > t)) {
                this._bufs[l].copy(e, c, u, u + a), c += t;
                break
            }
            this._bufs[l].copy(e, c, u), c += t, a -= t, u && (u = 0)
        }
...
function postInstantiate(e, t) {
    ...
    return e.__allocString = function (e) {
        ...
        if (r & VAL_MANAGED)
            for (let n = 0; n < a; ++n) p[(u >>> o) + n] = s(t[n]);
        else p.set(t, u >>> o);
        return h
        ...
        if (c >= 0) {
            ...
            if (a = a.substring(c + 1), s = s[r].prototype, /^(get|set):/.test(a)) {
                if (!Object.prototype.hasOwnProperty.call(s, a = a.substring(4))) {
                    let t = e[o.replace("set:", "get:")],
                        r = e[o.replace("get:", "set:")];
            ...
            } else "constructor" === a ? (s[a] = (...e) => (n(e.length), t(...e))).original = t : (s[a] = function (...e) {
                return n(e.length), t(this[THIS], ...e)
            }).original = t
        } else /^(get|set):/.test(a) ? Object.prototype.hasOwnProperty.call(s, a = a.substring(4)) || Object.defineProperty(s, a, {
            get: e[o.replace("set:", "get:")],
            set: e[o.replace("get:", "set:")],
            enumerable: !0
        }) : "function" == typeof t && t !== n ? (s[a] = (...e) => (n(e.length), t(...e))).original = t : s[a] = t
    }
    return r
}
...
async function* fixedSizeChunker(e, t) {
    ...
    for await (const s of e) for (r.append(s), n += s.length; n >= i;)
...
const bases = __spreadValues(__spreadValues(__spreadValues(__spreadValues(__spreadValues(__spreadValues(__spreadValues(__spreadValues(__spreadValues({}, identityBase), base2$1), base8$1), base10$1), base16$1), base32$2), base36$1), base58), base64$1);
...
class DirFlat extends Dir {
    ...
    async *flush(e) {
        ...
        for (let c = 0; c < t.length; c++) {
            ...
            if (n instanceof Dir)
                for await (const t of n.flush(e)) n = t, yield n;
...
class DirSharded extends Dir {
    ...
    async *flush(e) {
        for await (const t of flush(this._bucket, e, this, this.options)) yield __spreadProps(__spreadValues({}, t), {
            path: this.path
        })
    }
}
async function* flush(e, t, r, n) {
    ...
    for (let h = 0; h < o.length; h++) {
        ...
        if (e instanceof src$1.Bucket) {
            let o;
            for await (const r of await flush(e, t, null, n)) o = r;
            ...
            const n = e.value;
            let o;
            for await (const e of n.flush(t)) o = e, yield o;
            const a = r + e.key;
            i.push({
                Name: a,
                Tsize: o.size,
...
async function convertToShard(e, t) {
    ...
    for await (const {
        key: n,
        child: o
    } of e.eachChildSeries()) await r.put(n, o);
    return r
}
...
async function* treeBuilder(e, t, r) {
    ...
    for await (const o of e) o && (n = await addToTree(o, n, r), o.unixfs && o.unixfs.isDirectory() || (yield o));
    if (r.wrapWithDirectory) yield* flushAndYield(n, t);
    else
        for await (const o of n.eachChildSeries()) o && (yield* flushAndYield(o.child, t))
}
async function* importer(e, t, r = {}) {
    ...
    for await (const a of i(itParallelBatch(o(s, t, n), n.fileImportConcurrency), t, n)) yield {
        cid: a.cid,
        path: a.path,
        unixfs: a.unixfs,
        size: a.size
...
async function* toAsyncIterable(e) {
    if (isBytes$1(e)) yield toBytes(e);
    else if ("string" == typeof e || e instanceof String) yield toBytes(e.toString());
    else {
        if (!isBlob$1(e)) {
...
var normaliseInput$1 = async function* (e, t) {
    ...
    if ("string" == typeof e || e instanceof String) yield toFileObject(e.toString(), t);
    else if (isBytes(e) || isBlob(e)) yield toFileObject(e, t);
    else {
...
var adapter = BlockstoreAdapter$1,
    ...
    require$$2 = getAugmentedNamespace(raw$2),
...
async function pack({
    ...
    const s = t || new MemoryBlockStore,
        a = await itLast(pipe$1(normaliseInput_1.normaliseInput(e), (e => importer(e, s, __spreadProps(__spreadValues({}, unixfsImporterOptionsDefault), {
...
var decode$1 = function (e, t, r, n) {
        ...
        s > 0 && a > s && (a = s);
        for (var c = 0; c < a; ++c) {
            var u, l, f, h, d = e[c].replace(i, "%20"),
                p = d.indexOf(r);
    ...
    ! function (r) {
        ...
        function E(e) {
            ...
            for (o = r > 0 ? r + 1 : 0; o < g;) {
                ...
                v = $(b - i, t = y.length + 1, 0 == i), p(b / t) > c - w && m("overflow"), w += p(b / t), b %= t, y.splice(b++, 0, w)
            }
            return _(y)
        }

        function T(e) {
            var t, r, n, o, i, s, a, l, f, h, d, g, b, _, E, T = [];
            for (g = (e = w(e)).length, t = 128, r = 0, i = 72, s = 0; s < g; ++s)(d = e[s]) < 128 && T.push(y(d));
            for (n = o = T.length, o && T.push("-"); n < g;) {
                for (a = c, s = 0; s < g; ++s)(d = e[s]) >= t && d < a && (a = d);
                for (a - t > p((c - r) / (b = n + 1)) && m("overflow"), r += (a - t) * b, t = a, s = 0; s < g; ++s)
                    if ((d = e[s]) < t && ++r > c && m("overflow"), d == t) {
                        for (l = r, f = u; !(l < (h = f <= i ? 1 : f >= i + 26 ? 26 : f - i)); f += u) E = l - h, _ = u - h, T.push(y(v(h + E % _, 0))), l = p(E / _);
                        T.push(y(v(l, 0))), i = $(r, b, n == o), r = 0, ++n
                    }++ r, ++t
            }
            return T.join("")
        }
...
Url.prototype.parse = function (e, t, r) {
    ...
    if (!hostlessProtocol[c] && (l || c && !slashedProtocol[c])) {
        ...
        for (p = 0; p < nonHostChars.length; p++) {
            var y; - 1 !== (y = s.indexOf(nonHostChars[p])) && (-1 === d || y < d) && (d = y)
        } - 1 === d && (d = s.length), this.host = s.slice(0, d), s = s.slice(d), this.parseHost(), this.hostname = this.hostname || "";
        var m = "[" === this.hostname[0] && "]" === this.hostname[this.hostname.length - 1];
        if (!m)
            for (var g = this.hostname.split(/\./), b = (p = 0, g.length); p < b; p++) {
                var w = g[p];
                if (w && !w.match(hostnamePartPattern)) {
                    for (var _ = "", v = 0, $ = w.length; v < $; v++) w.charCodeAt(v) > 127 ? _ += "x" : _ += w[v];
                    if (!_.match(hostnamePartPattern)) {
                        var E = g.slice(0, p),
                            T = g.slice(p + 1),
                            B = w.match(hostnamePartStart);
                        B && (E.push(B[1]), T.unshift(B[2])), T.length && (s = "/" + T.join(".") + s), this.hostname = E.join(".");
                        break
                    }
                }
            }
        ...
        var A = this.port ? ":" + this.port : "",
            k = this.hostname || "";
        this.host = k + A, this.href += this.host, m && (this.hostname = this.hostname.substr(1, this.hostname.length - 2), "/" !== s[0] && (s = "/" + s))
    }
    if (!unsafeProtocol[u])
        for (p = 0, b = autoEscape.length; p < b; p++) {
            var S = autoEscape[p];
            if (-1 !== s.indexOf(S)) {
    ...
    if (_ && (r.hostname = "", r.port = null, r.host && ("" === w[0] ? w[0] = r.host : w.unshift(r.host)), r.host = "", e.protocol && (e.hostname = null, e.port = null, e.host && ("" === h[0] ? h[0] = e.host : h.unshift(e.host)), e.host = null), g = g && ("" === h[0] || "" === w[0])), m) r.host = e.host || "" === e.host ? e.host : r.host, r.hostname = e.hostname || "" === e.hostname ? e.hostname : r.hostname, r.search = e.search, r.query = e.query, w = h;
    else if (h.length) w || (w = []), w.pop(), w = w.concat(h), r.search = e.search, r.query = e.query;
    else if (!util.isNullOrUndefined(e.search)) {
        if (_) r.hostname = r.host = w.shift(), (B = !!(r.host && r.host.indexOf("@") > 0) && r.host.split("@")) && (r.auth = B.shift(), r.host = r.hostname = B.shift());
    ...
    for (var v = w.slice(-1)[0], $ = (r.host || e.host || w.length > 1) && ("." === v || ".." === v) || "" === v, E = 0, T = w.length; T >= 0; T--) "." === (v = w[T]) ? w.splice(T, 1) : ".." === v ? (w.splice(T, 1), E++) : E && (w.splice(T, 1), E--);
    if (!g && !b)
        for (; E--; E) w.unshift("..");
    !g || "" === w[0] || w[0] && "/" === w[0].charAt(0) || w.unshift(""), $ && "/" !== w.join("/").substr(-1) && w.push("");
    var B, A = "" === w[0] || w[0] && "/" === w[0].charAt(0);
    _ && (r.hostname = r.host = A ? "" : w.length ? w.shift() : "", (B = !!(r.host && r.host.indexOf("@") > 0) && r.host.split("@")) && (r.auth = B.shift(), r.host = r.hostname = B.shift()));
    return (g = g || r.host && w.length) && !A && w.unshift(""), w.length ? r.pathname = w.join("/") : (r.pathname = null, r.path = null), util.isNull(r.pathname) && util.isNull(r.search) || (r.path = (r.pathname ? r.pathname : "") + (r.search ? r.search : "")), r.auth = e.auth || r.auth, r.slashes = r.slashes || e.slashes, r.href = r.format(), r
...
var parseLinkHeader = function (e) {
    return e ? e.split(/,\s*</).map(parseLink).filter(hasRel).reduce(intoRels, {}) : null
};
...
}))), toPrefix = e => e.toString(16).toUpperCase().padStart(2, "0").substring(0, 2), toBucketPath = e => {
    let t = e.bucket;
    const r = [];
...
async function* emitBytes(e, t, r, n, o = 0, i) {
    if (t instanceof Uint8Array) {
        ...
        return e.length && (yield e), o += e.length
    }
    ...
    try {
        ...
        throw errCode$3(c, "ERR_NOT_UNIXFS")
    }
    ...
    let a = o;
    for (let u = 0; u < t.Links.length; u++) {
        const c = t.Links[u],
            l = o + s.blockSizes[u];
        if (r >= a && r < l || n > a && n <= l || r < a && n > l) {
            const t = await e.get(c.Hash, {
                signal: i.signal
            });
            let s;
            switch (c.Hash.code) {
                ...
                case code$3:
                    ...
                    break;
                default:
                    throw Error(`Unsupported codec: ${c.Hash.code}`)
            }
            for await (const a of emitBytes(e, s, r, n, o, i)) o += a.length, yield a
        }
        o = l, a = l + 1
    }
}
...
const findLinkCid = (e, t) => {
    ...
    unixFsResolver = async (e, t, r, n, o, i, s, a) => {
        ...
        try {
            ...
            throw errCode$3(f, "ERR_NOT_UNIXFS")
        }
        if (r || (r = t), n.length) {
            let e;
...
async function* recursive(e, t, r = {}) {
    ...
    if (n && (yield n, "directory" === n.type))
        for await (const o of async function* e(t, r) {
...
async function* unpackStream(e, {
    ...
    for (const s of t) yield* recursive(s, i)
}
...
const readonly = ({
    ...
    tree = function* (e, t) {
        if (null != e)
            for (const [r, n] of Object.entries(e)) {
                const e = [...t, r];
                if (yield e.join("/"), !(null == n || n instanceof Uint8Array || "object" != typeof n || CID$1.asCID(n)))
                    if (Array.isArray(n))
                        for (const [t, r] of n.entries()) {
                            const n = [...e, t];
    ...
    get = (e, t) => {
        ...
        for (const [n, o] of t.entries()) {
            if (r = r[o], null == r) throw new Error(`Object has no property at ${t.slice(0,n+1).map((e=>`[${JSON.stringify(e)}]`)).join("")}`);
            const e = CID$1.asCID(r);
            if (e) return {
                value: e,
                remaining: t.slice(n + 1).join("/")
            }
        }
        return {
            value: r
...
class TreewalkCarSplitter {
    constructor(e, t, r = {}) {
        ...
        this._reader = e, this._targetSize = t, this._decoders = [pb, raw$2, cbor, ...r.decoders || []]
    }
    async *cars() {
    ...
    async *_cars(e, t = [], r) {
        ...
        for (const [, o] of n.links())
            for await (const e of this._cars(o, t, r)) r = e.channel, yield e;
...
class Web3Storage {
    ...
    static async putCar({
        ...
        n && (u = __spreadProps(__spreadValues({}, u), {
            "X-Name": n
        }));
        ...
        const f = l[0].toString(),
            ...
            d = transform(MAX_CONCURRENT_UPLOADS, (async e => {
                const t = [];
                for await (const o of e) t.push(o);
    ...
    static async *list(e, {
        ...
        for await (const i of paginator((function ({
            ...
            return fetch(i.toString(), {
                method: "GET",
                headers: __spreadProps(__spreadValues({}, Web3Storage.headers(t)), {
...
async function toWeb3File({
    ...
    const n = [];
    for await (const i of e()) n.push(i);
